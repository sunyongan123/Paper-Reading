...
| 2026-09-05 | [📖 当日速览](2026-09-05/) | 1 篇 | 主题一句话：**GUI Agent 的"停手能力"** —— 当指令本身矛盾或与界面不符时，主流 agent 会过度顺从地盲执行（可行任务成功率 >70%，冲突成功率 <10%）；CONFLICTGUARD 用"可行性验证 + 条件激活引导"在推理期把冲突成功率拉到近六成且不伤可行任务。 |
